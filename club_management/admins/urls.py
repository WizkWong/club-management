...
urlpatterns = [
    ...
    path('request/all', views.manage_all_request, name='admin-request'),
    path('request/pending', views.manage_pending_request, name='admin-request-pending'),
    path('request/accept', views.manage_accept_request, name='admin-request-accept'),
    path('request/reject', views.manage_reject_request, name='admin-request-reject'),
